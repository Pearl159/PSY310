...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\IPE India\\Desktop\\UNI DATA\\PSY310\\wordpriming\\wordpriming_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('C:/Users/IPE India/Desktop/UNI DATA/PSY310/wordpriming/word_cond.xlsx'),
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('C:/Users/IPE India/Desktop/UNI DATA/PSY310/wordpriming/testwords.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('testroutine.started', globalClock.getTime(format='float'))
        text_2.setText(test)
        textbox.reset()
        ...
        # keep track of which components have finished
        testroutineComponents = [text_2, textbox, text_3, mouse]
        ...
        for thisComponent in testroutineComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('testroutine.stopped', globalClock.getTime(format='float'))
