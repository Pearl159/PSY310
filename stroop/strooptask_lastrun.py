...
expName = 'strooptask'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\IPE India\\Desktop\\UNI DATA\\PSY310\\stroop\\strooptask_lastrun.py',
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['r','b','y'], ignoreKeys=["escape"], waitRelease=False)
