...
expName = 'building'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\IPE India\\Desktop\\UNI DATA\\PSY310\\intentiaional binding\\intentionalbinding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='report the delay between the keypress and the beep sound on a scale of 0-999ms. click submit after entering the value\n',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=33.0, method='random', 
        ...
        trialList=data.importConditions('ib_cond.xlsx'),
