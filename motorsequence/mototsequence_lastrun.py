...
expName = 'mototsequence'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\IPE India\\Desktop\\UNI DATA\\PSY310\\motorsequence\\mototsequence_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=50.0, method='sequential', 
        ...
        trialList=data.importConditions('cond_seq.csv'),
    ...
    for thisTrial in trials:
        ...
        trialComponents = [fixation, line1, line2, line_3, line4, probe, key_resp]
