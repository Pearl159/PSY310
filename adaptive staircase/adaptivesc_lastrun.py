...
expName = 'adaptivesc'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\IPE India\\Desktop\\UNI DATA\\PSY310\\adaptive staircase\\adaptivesc_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.StairHandler(startVal=10.0, extraInfo=expInfo,
    ...
    level = thisTrial = 10.0  # initialise some vals
    ...
    for thisTrial in trials:
        ...
        trialComponents = [polygon, grating, key_resp]
